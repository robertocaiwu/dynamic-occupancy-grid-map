...
int main(int argc, const char** argv)
{
    ...
    grid_params.size = 128.0f;
    grid_params.resolution = 0.1f;
    grid_params.particle_count = 2 * static_cast<int>(10e5);
    grid_params.new_born_particle_count = 2 * static_cast<int>(10e4);
